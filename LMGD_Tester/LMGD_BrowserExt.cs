...
namespace LMGD_Tester
{
    class LMGD_BrowserExt
    {
        ...
        /// As of 7/2/2018, unworking with chromeDriver (suspected) Receive invalid cast exception in converting Seleium.RemoteDriver to ChromeWebelement/IWebDriver (Can't remember which atm). 
        /// </summary>
        ...
        public static void OpenUrlInNewTab(ChromeDriver browser, string url)
        {
            ...
            string script = "var d=document,a=d.createElement('a');a.type='submit';a.name='customer_number';a.innerHTML='"+ url +"';d.body.appendChild(a);return a;";
            // Execute the script 
